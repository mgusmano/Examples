...
class Layout: NSObject {
	...
	static var lightGreen: UIColor = UIColor(red:0.90, green:0.94, blue:0.95, alpha:1.0)
	...
	//static var color:UIColor = UIColor(red: 0/255, green: 204/255, blue: 102/255, alpha: 1)
